 ...
 const handleNext = () => {
  ...
  const handleBack = () => {
   ...
   const handleSaveProfile = () => {
    const profileData = {
      personalInfo: { firstName, lastName, age, gender, height, weight },
      prakriti: { bodyFrame, skinType, appetiteNature, temperatureTolerance, stressHandling },
      vikriti: { currentSymptoms, symptomDuration, severityLevel, aggravationTime },
      agni: { hungerRegularity, bloating, acidity, stoolType },
      ahara: { mealsPerDay, mealTimingConsistency, dominantFoodTypes, junkFoodFrequency },
      dinacharya: { wakeUpTime, sleepTime, sleepQuality, activityType, activityDuration },
      lifestyle: { stressLevel, workNature, lateNightHabit },
      medicalSafety: { existingConditions, currentMedications, allergies },
    };
  ...
  const MultiSelectButton = ({ selected, onPress, label }) => (
    <TouchableOpacity
      style={[styles.multiSelectButton, selected && styles.multiSelectButtonActive]}
      onPress={onPress}
    >
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      <Text style={styles.description}>
        To personalize your Ayurvedic health journey, please provide us with some basic
        personal details. This information helps us understand your unique constitution.
      </Text>
      ...
      case 2:
        return (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.description}>
              This section identifies your inborn physical and mental nature. Prakriti remains
              mostly constant throughout life and acts as the baseline for all recommendations.
            </Text>
      ...
      case 3:
        return (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.description}>
              This section captures your present health issues or imbalances. Vikriti can change
              over time and is evaluated along with Prakriti to personalize guidance.
            </Text>
              ...
              <View style={styles.multiSelectContainer}>
                {[
                  ...
                  <MultiSelectButton
                    ...
                    onPress={() => toggleArraySelection(currentSymptoms, setCurrentSymptoms, symptom)}
                    label={symptom}
                  />
                ))}
              </View>
      ...
      case 4:
        return (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.description}>
              This section assesses your digestive capacity, which is central to Ayurvedic
              decision-making. Weak or disturbed digestion directly affects the type of advice we
              can provide.
            </Text>
      ...
      case 5:
        return (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.description}>
              This section records your food habits and eating behavior. Diet-related
              recommendations are derived mainly from this data.
            </Text>
            ...
            <View style={styles.card}>
              ...
              <Text style={styles.label}>Dominant Food Types (select all that apply)</Text>
              <View style={styles.multiSelectContainer}>
                {['Spicy', 'Oily/Fried', 'Cold/Raw', 'Sweet', 'Sour', 'Salty', 'Bitter'].map(
                  (type) => (
                    <MultiSelectButton
                      key={type}
                      selected={dominantFoodTypes.includes(type)}
                      onPress={() =>
                        toggleArraySelection(dominantFoodTypes, setDominantFoodTypes, type)
                      }
                      label={type}
                    />
                  )
      ...
      case 6:
        return (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.description}>
              This section captures your daily routine and biological rhythm. Irregular routines
              are a common root cause of many health issues.
            </Text>
      ...
      case 7:
        return (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.description}>
              This section evaluates mental load and behavioral factors that influence long-term
              health.
            </Text>
      ...
      case 8:
        return (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.description}>
              This section ensures that all guidance provided remains safe and non-harmful.
            </Text>

            <View style={styles.card}>
              <Text style={styles.cardTitle}>Health Safety Information</Text>

              <Text style={styles.label}>Existing Diagnosed Conditions (select all that apply)</Text>
              <View style={styles.multiSelectContainer}>
                {[
                  'Diabetes',
                  'Hypertension',
                  ...
                  <MultiSelectButton
                    ...
                    onPress={() =>
                      toggleArraySelection(existingConditions, setExistingConditions, condition)
                    }
                    label={condition}
                  />
                ))}
            ...
            <View style={styles.noteContainer}>
              <Text style={styles.noteText}>
                The information you provide here will be used to personalize all future
                conversations and ensure your safety.
              </Text>
            </View>
          </View>
        );
